/**
 * Complete ISO-3166-1 numeric → alpha-2 country code mapping.
 *
 * Sourced from the ISO-3166-1 standard (249 entries).
 * Used by WorldMapSvg to map world-atlas TopoJSON numeric IDs to the
 * backend's alpha-2 country codes (stored in prayer_locations.country_code).
 *
 * Adding support for a new country requires no component edits — simply ensure
 * the backend stores the standard ISO-3166-1 alpha-2 code and this file covers it.
 */
export const ISO3166_NUMERIC_TO_ALPHA2: Readonly<Record<string, string>> = {
  '004': 'AF', // Afghanistan
  '008': 'AL', // Albania
  '010': 'AQ', // Antarctica
  '012': 'DZ', // Algeria
  ...
  '400': 'JO', // Jordan
  '404': 'KE', // Kenya
  '408': 'KP', // Korea, Democratic People's Republic
